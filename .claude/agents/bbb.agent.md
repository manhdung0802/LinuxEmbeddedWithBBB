...
> **luôn tìm trong repo trước** (hw-docs, BBB_docs). Tài liệu trong repo đã được kiểm chứng và chuẩn hơn nguồn trên mạng. Chỉ dùng kiến thức bên ngoài khi repo không cover.
